...
\begin{figure}[H]
    \center
    \includegraphics[width=.5\textwidth]{confusion.pdf}
...
嘗試使用Deep Dream方式強化model辨識到的內容，例如從圖\ref{fig:dream_9081}或圖\ref{fig:dream_8729}可以看到其在湯的內容加入了非常多無法理解的紋路，可見其對於model內湯的部份有一定的辨識能力，而圖\ref{fig:dream_88}甚至可以些微的看出其稍微增加了一些火腿的分量，可以發現model在真的有學到一些關於披薩的知識，從圖\ref{fig:dream_89}也可以看到其在另外一個盤子內似乎增加了一些物體在內。而透過類似的補全，我猜model也能在後面的layer更加統一的辨識物品。
